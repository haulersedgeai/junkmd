...
export interface Service {
  ...
  image?: string;
  /**
   * lucide-react icon name. When set (and `image` is empty), the service
   * card renders a branded icon panel instead of a real photo. Used for
   * services where no honest in-category photo exists.
   */
  icon?: string;
}
...
export const SERVICES: Service[] = [
  // ───────── RESIDENTIAL ─────────
  {
    ...
    pricing:
      "Minimum Load pickups start at $119. Most full living-room hauls fall in the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
    whyJunkMd:
    ...
    faqs: [
      ...
      { q: "What does it cost?", a: "We give you a flat, up-front price the moment we see the load. No hidden fees. Our Minimum Load starts at $119." },
    ],
  ...
  },
  {
    ...
    pricing:
      "Single-appliance pickup starts at the Minimum Load ($119). Multi-appliance hauls (e.g., full kitchen swap) typically fall in the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
    whyJunkMd:
  ...
  },
  {
    ...
    metaDescription:
      "Mattresses, box springs, bed frames — JunkMD+ hauls them away the same day and recycles foam and steel where possible. Minimum Load starts at $119.",
    ...
    pricing: "Single mattress pickup starts at the Minimum Load ($119). Mattress + box spring + frame combos usually fit in the 1/6 Truck ($272) to 1/4 Truck ($362) range.",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing:
      "Most full-estate jobs land in the 5/8 Truck ($697) to Full Truck ($899) range, or multi-truck. We quote on-site and you approve before we touch a thing.",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing:
      "Most garage cleanouts fall in the 1/6 Truck ($272) to 1/2 Truck ($579) range. Large overflowing garages reach 5/8 Truck ($697) or Full Truck ($899).",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Small yard-waste jobs start at the 1/8 Truck ($217) or 1/6 Truck ($272). Big tree-trim jobs often land in the 1/3 Truck ($467) or 1/2 Truck ($579) range.",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Typical single-room or hallway runs land in the 1/6 Truck ($272) to 1/4 Truck ($362) range. Whole-house carpet pulls can reach 1/2 Truck ($579) or Full Truck ($899).",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Single-item TV/electronics pickups start at the Minimum Load ($119). Office-clearing e-waste batches fall in the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
    whyJunkMd:
  ...
  },
  {
    ...
    metaDescription:
      "Old fridges, freezers, mini-fridges, wine coolers — JunkMD+ hauls them out and routes freon to EPA-compliant recovery. Minimum Load starts at $119.",
    ...
    pricing: "Single fridge pickup starts at the Minimum Load ($119). Multi-appliance hauls bundle into the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Custom-quoted by truckload. Volume discounts kick in past one Full Truck ($899).",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Quoted on-site. Most full restaurant closeouts run multiple Full Trucks ($899 each).",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Quoted on-site. Most full-store closeouts run multiple Full Trucks ($899 each).",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Quoted on-site. Most single-unit pickups fit in the 1/2 Truck ($579) range; full commercial kitchens run Full Truck ($899) or multi-truck.",
    whyJunkMd:
  ...
  },
  {
    ...
    pricing: "Most full kitchen demos land in the 7/8 Truck ($787) to Full Truck ($899) range, or multi-load.",
  ...
  },
  {
    ...
    pricing: "Single-item TV/electronics pickup starts at the Minimum Load ($119). Office e-waste batches fit in the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
  ...
  },
  {
    ...
    pricing: "Single-item pickup starts at the Minimum Load ($119). Multi-piece home gyms typically fall in the 1/6 Truck ($272) to 1/2 Truck ($579) range.",
  ...
  },
  {
    ...
    pricing: "The 1/6 Truck ($272) or 1/4 Truck ($362) size typically covers a household worth of moving boxes.",
  ...
  },
  {
    ...
    category: "what-we-take",
    title: "Couch Removal",
    metaTitle: "Couch Removal San Diego — Sofas & Sectionals Hauled (Starting $119)",
    metaDescription:
      "Couches, sectionals, sleeper sofas, loveseats — JunkMD+ hauls them out of any room. Starting at $119 for a Minimum Load. Save $20 on first appointment.",
    hero: "Couches, sectionals, sleeper sofas — out of the living room and gone today. Starting at $119.",
    intro:
    ...
    pricing: "Single couch pickup starts at the Minimum Load ($119). Sectionals and sleeper sofas typically fall in the 1/6 Truck ($272) to 1/4 Truck ($362) range.",
