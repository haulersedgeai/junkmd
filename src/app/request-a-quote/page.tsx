      ...
      <section className="py-12 bg-white">
        <div className="container-x grid md:grid-cols-3 gap-6">
          <div className="text-center p-6 rounded-xl bg-[color:var(--brand-bg-soft)] border border-[color:var(--brand-border)]">
            ...
            <a href={`sms:${SITE.phoneRaw}`} className="btn btn-outline">Text {SITE.phone}</a>
          </div>
          <div className="text-center p-6 rounded-xl bg-[color:var(--brand-bg-soft)] border border-[color:var(--brand-border)]">
            ...
            <a href={SITE.bookingUrl} target="_blank" rel="noopener noreferrer" className="btn btn-accent">Book Online</a>
          </div>
          <div className="text-center p-6 rounded-xl bg-[color:var(--brand-bg-soft)] border border-[color:var(--brand-border)]">
            ...
            <a href={`tel:${SITE.phoneRaw}`} className="btn btn-outline">Call {SITE.phone}</a>
          </div>
        </div>
      </section>
